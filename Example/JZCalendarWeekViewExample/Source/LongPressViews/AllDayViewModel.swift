...
class AllDayViewModel: NSObject {
    ...
    private let fourthDate = Date().add(component: .day, value: 4)
    ...
    lazy var events = [AllDayEvent(id: "0", title: "One", startDate: firstDate, endDate: firstDate.add(component: .hour, value: 1), location: "Melbourne", isAllDay: false),
                       ...
                       AllDayEvent(id: "8", title: "Five", startDate: fourthDate, endDate: fourthDate.add(component: .minute, value: 10), location: "Brisbane", isAllDay: false)]
