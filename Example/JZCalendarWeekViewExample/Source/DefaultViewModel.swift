...
class DefaultViewModel: NSObject {
    ...
    private let fourthDate = Date().add(component: .day, value: 3)
    ...
    lazy var events = [DefaultEvent(id: "0", title: "One", startDate: firstDate, endDate: firstDate.add(component: .hour, value: 1), location: "Melbourne"),
                       ...
                       DefaultEvent(id: "4", title: "Five", startDate: fourthDate, endDate: fourthDate.add(component: .minute, value: 20), location: "Canberra")]
